            ...
            <div class="col-75-checkout">
                <div class="container">
                    <form method="post" action="checkout.php">
                        ...
                        <div class="row-checkout">
                            ...
                            <div class="col-50">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="cname" name="cardname" placeholder="John M Doe">
                                </div>
                                <div class="input-group">
                        ...
                        <div class="input-group">
                            <a class="btn" href="thankyou.php">Continue</a>
			            </div>
                    </form>
                </div>
            </div>

            <div class="col-25-checkout">
                <div class="container-checkout">
                    <h4>Cart <span class="price-checkout" style="color:black">
                    <i class="fa fa-shopping-cart"></i></span></h4>
                    <!---<p><a href="#">IPHONE</a> <span class="price-checkout">$1500</span></p>
                    <p><a href="#">SAMSUNG</a> <span class="price-checkout">$500</span></p>--->
                    
                    <div class="products-checkout">
                        
                    </div>
                    <!--<hr><p>Total <span class="price-checkout" style="color:black"><b>$2600</b></span></p>-->
                </div>
            </div>
        </div>
